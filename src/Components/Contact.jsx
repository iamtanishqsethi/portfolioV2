...
const Contact = () => {
    ...
    return (
        <div
            ref={ref}
            className={` transition-all duration-1000 ${isVisible? 'opacity-100 translate-y-0 ':'opacity-0 translate-y-10'} text-white px-6 md:px-16 lg:px-32 flex flex-col items-center justify-center my-12 py-12`}>
            ...
            <a href="mailto:tanishqsethi05@gmail.com?subject=Contact%20Request&body=Hi%20there,%0D%0A%0D%0AI%20would%20like%20to%20get%20in%20touch%20with%20you%0D%0A%0D%0AThank%20you!">
                <button className="transition ease-in-out bg-black bg-opacity-40 border-2 border-amber-500 my-8 py-3 px-6 md:py-4 md:px-8 text-amber-500 rounded-xl hover:bg-amber-500 hover:text-white hover:font-bold">
                    Contact Me!
                </button>
            </a>
        </div>
