...
const Login=()=>{
    ...
    return (
        <div className={'flex flex-col items-center justify-center text-white h-screen'}>
            <form className={'bg-gradient-to-br from-zinc-950/50 via-zinc-900/50 to-zinc-800/50 backdrop-blur-xl rounded-xl  h-[60%] lg:h-[68%] w-[90%] lg:w-[28%] p-8 flex flex-col items-center '}>
